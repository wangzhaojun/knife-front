...
.app-logo{
  ...
  .app-logo-icon {
    // background: url(../../images/WE_LOGO.png); 
...
<template>
  <div class="app-logo"><router-link to="/view1"><span class="app-logo-text"></span>
    <img style="height: 65px;transform: scale(0.7);" src="../../images/WE_LOGO.png" />
  </router-link></div>
</template>
<script>
export default {
